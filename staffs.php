                ...
                <div class="panel-body">
                    <div class="panel-group" id="accordion"><br/><br/>
                        <table  class="table table-striped table-bordered" id="tableData">
                            ...
                            if(isset($_GET['delete'])){
                                ...
                                if($row['privilage']=="all"){
                                    ...
                                    $statement=$db->prepare($query);
                                    $statement->execute();
                                    echo "<br/><b style='color:red;padding-left:1%;'> * User name deleted successfully</b> ";
                                }
                            }
                        ...
                        <table  class="table table-striped table-bordered" id="tableData">
                            ...
                            $query = "select * from user_details WHERE privilage = 'Staff' order by first_name ASC";
                            $j=1;
                            echo"<tr><td>#</td><td>Name</td><td>Customer ID</td><td>E-Mail</td><td style='text-align:center'>Mobile</td><td colspan='2' style='text-align:center;width: 4%'>Action</td></tr>";
                            ...
                            foreach($row1 as $row){
                                ...
                                $user_id=$row['user_id'];
                                $mobile=$row['phone_number'];
                                echo"<tr><td>".$j."</td><td>".strtoupper($full_name)."</i></td><td><a data-toggle='myToolTip' class='tooltip-style' data-placement='bottom' title='".$row['privilage']."' >".$user_id."</a></td><td><a>".$email."</a></td><td><a>".$mobile."</a></td><td style='text-align:center'>";
                                if($privilege=="admin"){ 
                                echo " <form action='staffs.php'><button id='btn_1' name='delete'><span class='fa fa-trash'></span></button></td><td style='text-align:center'><button id='btn_2' name='edit'><span class='fa fa-edit'></span></button><input type='hidden' name='id' value='".$user_id."'></form>";
                                }
                                echo "</td></tr>";
                                $j++;
                            }
                            ...
                            if($j<=1){
                                echo"<tr><td colspan='6'><b><i style='color:red;'>No Customer added please add customer</i></td></tr>";
                            }
